...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubmissionDocument.submitter'
        db.add_column(u'wopa_submitter_submissiondocument', 'submitter',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubmissionDocument.submitter'
        db.delete_column(u'wopa_submitter_submissiondocument', 'submitter_id')
