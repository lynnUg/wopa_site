...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reading.reading'
        db.add_column(u'wopa_submitter_reading', 'reading',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wopa_submitter.ReadingDocuments'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Reading.reading'
        db.delete_column(u'wopa_submitter_reading', 'reading_id')
