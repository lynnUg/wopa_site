...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reading.is_published'
        db.add_column(u'wopa_submitter_reading', 'is_published',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reading.is_published'
        db.delete_column(u'wopa_submitter_reading', 'is_published')
